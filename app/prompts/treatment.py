...
ASC 606 guidance and RevLens company policy for that contract. Make six
...
Make the following six judgments. For each, give reasoning (separating the ASC 606
...
1. onboarding_distinct - is the onboarding / implementation service a distinct
   ...
   standardized, or platform access does not depend on it). If the contract is genuinely
   unclear about distinctness, answer "UNDETERMINED" rather than defaulting to "FALSE".
...
4. material_right - does a renewal or future-purchase option give the customer a
   ...
   The mere absence of a stated renewal price means list-price renewal, i.e. "FALSE".
   Answer "UNDETERMINED" only when the contract itself mentions a discounted renewal or
   option but gives too little to judge whether it is material.
